...
export const HUMANITARIAN_SOLUTIONS: HumanitarianSolution[] = [
  {
    ...
    icon: 'Heart',
    sourceUrl: 'https://www.icrc.org/en/what-we-do/mental-health'
  },
  {
    ...
    icon: 'Anchor',
    sourceUrl: 'https://www.who.int/news-room/fact-sheets/detail/mental-health-in-emergencies'
  },
  {
    ...
    icon: 'Droplets',
    sourceUrl: 'https://www.cdc.gov/healthywater/emergency/making-water-safe.html'
  },
  {
    id: 'grid-down-prep',
  ...
  },
  {
    ...
    icon: 'Users',
    sourceUrl: 'https://www.ready.gov/neighbors'
  },
  {
    id: 'medical-triage',
    ...
    icon: 'ShieldCheck',
    sourceUrl: 'https://www.naemt.org/education/tecc'
  }
];
